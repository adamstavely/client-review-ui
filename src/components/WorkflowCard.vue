  ...
  <v-card class="bg-white dark:bg-slate-800 rounded-lg shadow-lg mb-4" elevation="0">
    <v-card-title class="d-flex align-center justify-space-between pa-0">
      ...
      <button
        ...
        class="px-3 py-1.5 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-500 transition-colors d-flex align-center ga-1 mr-4"
      >
