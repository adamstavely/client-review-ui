<template>
  <v-card class="bg-white rounded-lg shadow-lg mb-4">
    <v-card-title class="d-flex align-center pa-0">
      <div class="d-flex align-center w-100" style="padding: 12px 16px;">
        ...
        <span class="text-left uppercase">Workflow</span>
      </div>
    </v-card-title>
    ...
    <v-card-text class="pa-4">
      ...
      <div v-if="canApproveWorkflow" class="mb-3">
        <div class="d-flex flex-column ga-2">
          <span class="text-sm font-medium text-gray-700">{{ getWorkflowActionText() }}</span>
          <div class="d-flex align-center flex-wrap ga-2">
            <button
              @click="handleApprove"
              class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors d-flex align-center ga-2"
            >
            ...
            <button
              @click="handleReject"
              class="px-4 py-2 text-sm font-medium text-indigo-600 bg-white border border-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors d-flex align-center ga-2"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="isDesigner && workflowState === 'draft'" class="mb-3">
          <button
            ...
            class="px-3 py-1.5 text-xs font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors d-flex align-center ga-1"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
